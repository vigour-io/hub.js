...
const sendToServer = (val, stamp, struct) => {
  ...
  if (hub && bs.type(stamp) !== 'receive') { toServer(hub, val, stamp, struct) }
}
...
const define = {
  subscribe (subs, cb, raw) {
    ...
    return subscribe(this, subs, cb || stub)
  }
}
