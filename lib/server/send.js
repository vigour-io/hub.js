...
const send = (hub, client, struct, type, subs, tree) => {
  if (client.val !== null) {
    ...
    if (client.context !== hub.contextKey) {
      console.log('\n🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥 WRONG AS FUCK 🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥')
    }
    console.log('trying to send to remove client weird...', client.id, client.context, hub.contextKey, ':', hub.subscriptions.map(val => val.id))
  }
}
