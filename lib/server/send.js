  ...
  if ((val === null || !(cached = isCached(client, struct, stamp))) || subs.val === true) {
    ...
    if (
      ...
      if (
        ...
        console.log('3 XXXX --- YYY', cached, struct.path(), struct.val)
        if (subs.type) {
